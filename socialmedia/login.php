    ...
    <body>
        ...
        <main class="main-wrapper" style="display: flex; justify-content: center; align-items: center; min-height: 70vh;">
            <div id="form" style="max-width: 400px; width: 90%; border: 2px solid <?= $border ?>; padding: 40px; border-radius: 20px; background: <?= $bg ?>;">
                ...
                <h2 style="text-transform: uppercase; color: <?= $border ?>; margin-bottom: 25px; letter-spacing: 2px;">
                    System Access
                </h2>

                <div style="text-align: left;">
                    <label style="font-size: 0.8rem; opacity: 0.7;">IDENTIFIER</label>
                    ...
                    <label style="font-size: 0.8rem; opacity: 0.7;">SECURITY KEY</label>
