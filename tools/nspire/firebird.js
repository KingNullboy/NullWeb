	...
	"preRun": function() {
		...
		fileLoaded = function(event, filename) {
			if (event.target.readyState == FileReader.DONE)
				FS.writeFile(filename, new Uint8Array(event.target.result), {
					encoding: "binary"
				})
		}
		;
...
var DYNAMIC_BASE = 5689232
  , DYNAMICTOP_PTR = 446192;
...
var wasmBinaryFile = "firebird.wasm";
...
var asmLibraryArg = {
	...
	"l": _emscripten_set_main_loop_arg,
	"o": _exit,
	"c": _fd_close,
	"y": _fd_read,
	"q": _fd_seek,
	...
	"v": _pthread_cond_timedwait,
	"h": _pthread_mutexattr_destroy,
...
var _htons = Module["_htons"] = function() {
	return (_htons = Module["_htons"] = Module["asm"]["E"]).apply(null, arguments)
}
;
...
;
var _paintLCD = Module["_paintLCD"] = function() {
	return (_paintLCD = Module["_paintLCD"] = Module["asm"]["H"]).apply(null, arguments)
}
;
...
var _ntohs = Module["_ntohs"] = function() {
	return (_ntohs = Module["_ntohs"] = Module["asm"]["J"]).apply(null, arguments)
}
;
var __ZSt18uncaught_exceptionv = Module["__ZSt18uncaught_exceptionv"] = function() {
	return (__ZSt18uncaught_exceptionv = Module["__ZSt18uncaught_exceptionv"] = Module["asm"]["K"]).apply(null, arguments)
}
;
var _memalign = Module["_memalign"] = function() {
	return (_memalign = Module["_memalign"] = Module["asm"]["L"]).apply(null, arguments)
}
;
...
var dynCall_v = Module["dynCall_v"] = function() {
	return (dynCall_v = Module["dynCall_v"] = Module["asm"]["Q"]).apply(null, arguments)
}
;
Module["asm"] = asm;
Module["cwrap"] = cwrap;
